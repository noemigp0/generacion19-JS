...
//DOMContentLoades  --> es el equivalenye a onload
//DOM
//document.addEventListener('DOMContentLoaded', loadAlbumes)


//Si dependemos de que el usuario presione un boton
//let botonCargar = document.querySelector('#btnAlbumes')
//cuando des click en el boton #btnAlbumes presiona esto
//botonCargar.addEventListener('click', loadAlbumes)


//Ejercicio 1. pintar todos los posts cuando carge el documento
 ...
 */
 ...
 let posts = [
  ...
  const loadPosts = (postsArray) => {
    let template = postsArray.reduce((acc, cv) => {
      return acc += `
  ...
  document.addEventListener('DOMContentLoaded', loadPosts(posts))
